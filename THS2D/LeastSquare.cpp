...
double LeastSquare::f_source(const array<double, 3>& x)
{
...
double LeastSquare::f_source_7(const array<double, 3>& x)
{
...
double LeastSquare::exact_sol(const array<double, 3>& x)
{
...
double LeastSquare::exact_sol_7(const array<double, 3>& x)
{
